...
export async function POST(request) {
  try {
    ...
    const { name, email, phone, travelDate, travelers, packageType, vehicleType, message } = bookingData;
    ...
    const customerEmailContent = `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #ddd;">
        <div style="text-align: center; margin-bottom: 20px;">
          <h1 style="color: #ff6600; margin: 0;">J TOORS</h1>
        ...
        <p style="font-size: 16px; color: #333;">Thank you for choosing J Toors for your Sri Lanka adventure! We have received your booking request.</p>
        ...
        <div style="text-align: center; margin-top: 30px; padding-top: 20px; border-top: 1px solid #ddd;">
          <p style="color: #999; font-size: 12px;">© 2024 J Toors. All rights reserved.</p>
    ...
    if (process.env.GMAIL_USER && process.env.GMAIL_APP_PASSWORD) {
      try {
        ...
        await transporter.sendMail({
          from: `"J Toors" <${process.env.GMAIL_USER}>`,
          to: 'j.tours.rent@gmail.com',
          subject: '🔔 New Booking Received - J Toors',
        ...
        await transporter.sendMail({
          from: `"J Toors" <${process.env.GMAIL_USER}>`,
          to: email,
          subject: '✅ Booking Confirmation - J Toors',
    ...
    return NextResponse.json({
      ...
      emails: {
        ...
        customer: {
          to: email,
          subject: 'Booking Confirmation - J Toors',
          preview: 'Thank you for your booking with J Toors'
        }
      }
    });
